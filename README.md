...
## 📄 Sobre
O projeto foi construido e desenvolvido junto ao curso de c# orientação a objeto, ministrado pelo prof. Nélio Alves, na plataforma da udemy com emissão de certificado.
...
e filtros de vendas em grupo. Esse projeto foi construido com o c# utilizando o framework dotnet, banco de dados my sql e um tema em bootstrap para personalizar o front-end.
...
✅ - O softwares sejam aderentes a 
LGPD (Lei geral de proteção de dados).

✅ - A empresa necessita que a implementação seja feita na 
linguagem de programação C# com framewrork dotnet.
